...
本项目（`oem2api`）于 **2026-09-05** 克隆自 [Wei-Shaw/sub2api](https://github.com/Wei-Shaw/sub2api)。

- 上游分支：`main`
- 版本文件 `backend/cmd/server/VERSION` 中的版本号：`0.2.7`
- 导入快照提交：[`b1748c4ea99ce2120401a269142aa071e18a84da`](https://github.com/Wei-Shaw/sub2api/commit/b1748c4ea99ce2120401a269142aa071e18a84da)
- 于 **2026-09-20** 同步至上游标签 `v0.2.7`（提交 `aea725f2ea644d5592d0bbb1d63b607efa7e200a`）。
