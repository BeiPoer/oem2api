...
This repository (`oem2api`) was cloned from [Wei-Shaw/sub2api](https://github.com/Wei-Shaw/sub2api) on **2026-09-05**.

- Upstream branch: `main`
- Version recorded in `backend/cmd/server/VERSION`: `0.2.7`
- Imported snapshot: [`b1748c4ea99ce2120401a269142aa071e18a84da`](https://github.com/Wei-Shaw/sub2api/commit/b1748c4ea99ce2120401a269142aa071e18a84da)
- Synced on **2026-09-20** to upstream tag `v0.2.7` (commit `aea725f2ea644d5592d0bbb1d63b607efa7e200a`).
